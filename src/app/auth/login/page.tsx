    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-4 relative overflow-hidden">
      ...
      >
        <div className="text-center mb-6">
          ...
          <h1 className="text-3xl font-black text-purple-600">家長登入</h1>
          <p className="text-gray-400 text-sm mt-1">登入管理你的孩子學習</p>
        </div>
        ...
        <form onSubmit={login} className="space-y-4">
          ...
          <div>
            <label className="block text-sm font-bold text-gray-600 mb-1">密碼</label>
            <input
              type="password"
              value={password}
        ...
        >
          <span className="text-xl">🌐</span> 用 Google 登入
        </motion.button>

        <p className="text-center text-gray-400 text-sm mt-6">
          還沒有帳號？{' '}
          <button onClick={() => router.push('/auth/register')} className="text-purple-500 font-bold">
            立即註冊
          </button>
        </p>
      </motion.div>
